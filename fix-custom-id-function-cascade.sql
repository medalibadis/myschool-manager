-- =====================================================
-- FIX CUSTOM ID GENERATION FUNCTION - WITH CASCADE
-- This fixes the type mismatch error by properly dropping dependent objects
-- =====================================================

-- 1. Drop the existing function with CASCADE to remove dependent triggers
DROP FUNCTION IF EXISTS generate_custom_id() CASCADE;
...
-- 3. Create the trigger for automatic custom_id generation
