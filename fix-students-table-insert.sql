-- =====================================================
-- FIX STUDENTS TABLE FOR STUDENT CREATION
-- This checks and fixes the students table structure for adding students from waiting list
-- =====================================================
...
-- 5. Test inserting a student with the new structure
