...
('قطر الندى بن عيسى', NULL, '555481112', 'حي 17 اكتوبر', NULL, NULL, '662066922', 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
('الزهراء بن عون', NULL, '676132004', 'حي الصحن الاول', NULL, NULL, NULL, 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
('فاطمة الزهراء بالخير', NULL, '667878434', 'حي الشهداء', NULL, NULL, '795660654', 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
...
('ملاك بن عيسى', NULL, '676132004', 'حي النور', NULL, NULL, '658492749', 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
('محمد الطاهر سروطي', NULL, '667878434', 'حي الفاتح ماي', NULL, NULL, NULL, 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
('العلمي الحاج عمر', NULL, '658502296', 'حي البياضة', NULL, NULL, '668895055', 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
('محمد السعيد احمادي', NULL, '555481112', 'حي المصاعبة', NULL, NULL, '666475512', 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
('فاتن زكور محمد', NULL, '676132004', 'حي الشهداء', NULL, NULL, '775770043', 0.00, 'English', 'A1+', 'Adults', NULL, true, 500.00),
...
SELECT '✅ 20 students added to waiting list for English A2 Adults group!' as final_status;
